      ...
      <div className="max-w-4xl mx-auto p-4 md:p-8 space-y-8">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Review your recent Audio and Video interactions.
          </p>
        </div>
        ...
        <div className="space-y-4">
          {isLoading ? (
            Array.from({ length: 5 }).map((_, i) => (
              <Card
                key={i}
                className="rounded-2xl border-white/5 bg-muted/5 shadow-none"
              >
            ...
            calls.map((call) => {
              ...
              return (
                <Card
                  key={call.id}
                  className="rounded-2xl border-white/5 bg-muted/5 hover:bg-muted/10 transition-colors shadow-none cursor-default group"
                >
                  <CardContent className="p-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
