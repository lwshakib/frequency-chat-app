      ...
      <div className="max-w-4xl mx-auto p-4 md:p-8 space-y-8">
        ...
        <div className="space-y-12 pb-20">
          ...
          <section id="profile" className="space-y-4">
            <h2 className="text-sm font-bold tracking-wide text-muted-foreground/60 px-1">
              Profile Information
            </h2>
                ...
                <form onSubmit={handleUpdateProfile} className="space-y-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input
                      ...
                      value={email}
                      disabled
                      className="rounded-xl h-11 opacity-50 bg-muted"
                    />
                    <p className="text-[10px] text-muted-foreground pl-1">
                      Email cannot be changed through the profile settings.
                    </p>
                  </div>
                  <Button
                    type="submit"
            ...
            <div className="grid gap-6">
              ...
              <Card className="rounded-2xl border-white/5 shadow-xl bg-muted/5">
                <CardHeader>
                  ...
                  <CardDescription>
                    Manage your active sessions across different platforms.
                  </CardDescription>
                </CardHeader>
              ...
              <CardContent className="space-y-4 pt-6">
                {accounts.length === 0 && (
                  <p className="text-sm text-muted-foreground py-4 text-center">
                    No third-party accounts connected yet.
                  </p>
                )}
                {accounts.map((acc) => (
                  <div
          ...
          <section id="danger" className="space-y-4">
            <h2 className="text-sm font-bold tracking-wide text-destructive/60 px-1">
              Danger Zone
            </h2>
            <Card className="rounded-2xl border-destructive/20 border-2 shadow-xl bg-destructive/[0.02]">
              <CardHeader>
                ...
                <CardDescription>
                  Permanently erase your identity and data from Frequency.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Deleting your account is irreversible. Your messages, groups,
                  and media will be wiped.
                </p>
              </CardContent>
                  ...
                  <AlertDialogContent className="rounded-2xl border-destructive/20">
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        ...
                        data from our servers. This includes your message
                        history and all group memberships.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
